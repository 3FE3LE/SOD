  ...
  return (
    <>
      <div className="w-full flex flex-wrap justify-center">
        ...
        <div className="max-w-screen-lg h-full w-full flex flex-wrap justify-center px-4 pt-20">
          ...
          <div className="w-full sm:w-1/2 md:w-1/4 flex justify-around">
            ...
            <div className="sm:w-1/2 my-2">
              <h1 className="uppercase font-bold my-4">Enlaces rápidos</h1>
              <ul>
                <li>Inicio</li>
                <li>Cajas</li>
                <li>Tienda</li>
            ...
            <div className="sm:w-1/2 my-2">
              <h1 className="uppercase font-bold my-4">Cuenta</h1>
              <ul>
                <li>Mi cuenta</li>
                <li>Mis ordenes</li>
                <li>Compras</li>
          ...
          <div className="w-full sm:w-full md:w-4/12 my-2">
            <h1 className="uppercase font-bold my-4">Newsletter</h1>
