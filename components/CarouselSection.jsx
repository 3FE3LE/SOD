...
const CarouselSection = () => {
  ...
  return (
    <div className="w-full h-64 bg-gray-600 flex justify-center bg-cover bg-center bg-no-repeat object-cover" style={{ backgroundImage: "url('https://colorlib.com/preview/theme/ashion/img/banner/banner-1.jpg')" }}>
